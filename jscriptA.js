...
//w3 schools JavaScript Function Call. More about 'this', 'call' and 'apply'. 
...
function oneFunc() {
    const a= 4;
    //return a * a;   
    document.getElementById("boba1").innerHTML= "Function accessing inside or local variable..." + " " + a * a;
...
//Function accessing outside or global variable
    const b= 4;
    function twoFunc() {
        document.getElementById("boba2").innerHTML= "Function accessing outside or global variable..." + b * b;
    }
    console.log(b * b);
